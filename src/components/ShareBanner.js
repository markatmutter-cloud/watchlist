...
// - Anonymous:   passive "Sign in to save" CTA. No data written until
//                they sign in. Spec is explicit: no growth-funnel
//                friction, no nag.
//
// Sender identity isn't exposed in v1 (Q7 default). Banner just says
// "Shared with you on Watchlist." — the sender is identified via
// whatever messaging app the link came in.
//
// Both action handlers are passed in by App.js. Dismiss is always
// present (closes the banner without writing anything beyond the
// shared-with-me record where applicable). Save is gated on the user
// being signed in.
