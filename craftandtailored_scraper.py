#!/usr/bin/env python3
"""
Craft & Tailored scraper - Shopify public products API.
Run: python3 craftandtailored_scraper.py
Requires: pip install requests
Output: craftandtailored_listings.csv
"""
import requests
import csv
import re
...
BASE = "https://craftandtailored.com"
...
def detect_brand(name, vendor=""):
    if vendor and vendor.strip().lower() not in ['craft & tailored', 'craft and tailored', 'craftandtailored', '']:
        for b in BRANDS:
...
def main():
    print("Fetching Craft & Tailored inventory...")
