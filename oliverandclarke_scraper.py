#!/usr/bin/env python3
"""
Oliver & Clarke scraper - Shopify public products API.
Run: python3 oliverandclarke_scraper.py
Requires: pip install requests
Output: oliverandclarke_listings.csv
"""
import requests
import csv
import re
...
BASE = "https://oliverandclarke.com"
...
def parse_product(p):
    title = p.get('title', '')
    vendor = p.get('vendor', '')
    body = strip_html(p.get('body_html', ''))[:3500]
...
def main():
    print("Fetching Oliver & Clarke inventory...")
