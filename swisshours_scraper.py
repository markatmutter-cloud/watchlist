...
Run: python3 swisshours_scraper.py
Output: swisshours_listings.csv
"""
...
BASE = "https://swisshours.com"
COLLECTION_PATH = "/collections/watches"
...
def detect_brand(name, vendor=""):
    if vendor and vendor not in ("Swiss Hours", "swisshours.com", ""):
        for b in BRANDS:
...
def main():
    print("Fetching Swiss Hours watches collection...")
