#!/usr/bin/env python3
"""
Falco Watches scraper - Shopify public products API
Run: python3 falco_scraper.py
Requires: pip install requests
Output: falco_listings.csv
"""
...
def detect_brand(name, vendor=""):
    if vendor and vendor not in ['Falco', 'falco-watches', 'Falco Watches', '']:
        for b in BRANDS:
...
def parse_product(p):
    ...
    published_at = p.get('published_at', '2026-04-19')[:10]
    handle = p.get('handle', '')
...
def main():
    print("Fetching Falco Watches inventory...")
